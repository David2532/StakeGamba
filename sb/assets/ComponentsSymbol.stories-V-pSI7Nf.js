import{p as X,t as g,f as t,n as Z,s as S,a as n,b as ee,c as te,e as x,g as e,d as o}from"./iframe-C73VJLO7.js";import{c as ne,i as oe,d as ae,b as H,e as R,C as F,f as y,g as d,T as G}from"./create-runtime-stories-CYWc95Y6.js";import{S as u}from"./Symbol-DAPxgHIo.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./tweened-C0HaEC-Q.js";const W=["static","spin","land","win","postWinStatic","explosion"],se={title:"Components/<Symbol>",component:u,args:{x:100,y:100,rawSymbol:{name:"S",scatter:!0},state:"static"}},{Story:q}=ae();var re=g("<!> <!>",1),me=g("<!> <!>",1),le=g("<!> <!>",1),ce=g("<!> <!>",1);function j(z,D){X(D,!1);const _=180,J=[{name:"L1"},{name:"L2"},{name:"L3"},{name:"L4"},{name:"L5"}],K=[{name:"S"},{name:"W",multiplier:2},{name:"H1"},{name:"H3"},{name:"H2"},{name:"H4"}];oe();var P=ce(),M=t(P);q(M,{name:"component",template:($,v=Z)=>{H($,{assets:R,children:(O,f)=>{u(O,te(v,{oncomplete:()=>console.log("complete")}))},$$slots:{default:!0}})},$$slots:{template:!0},parameters:{__svelteCsf:{rawCode:`<StoryPixiApp {assets}>
