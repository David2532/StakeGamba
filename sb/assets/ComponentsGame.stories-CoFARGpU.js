import{p as y,t as L,f as G,s as d,n as C,g as c,a as E,b as P,d as p}from"./iframe-NxxLT44i.js";import{c as k,i as h,d as w,S as g,a as T}from"./create-runtime-stories-BzM27n79.js";import{s as B,G as S,t as m}from"./Game-DLlVnVNG.js";import{s as H,c as b,a as x,e as O}from"./Symbol-DV0gVVZM.js";import"./_commonjsHelpers-Cpj98o6Y.js";const l=(o,t=C)=>{T(o,{get skipLoadingScreen(){return t().skipLoadingScreen},action:async()=>{var e,a;await((a=(e=t()).action)==null?void 0:a.call(e,t().data))},children:(e,a)=>{g(e,{lang:"en",children:(n,i)=>{S(n,{})},$$slots:{default:!0}})},$$slots:{default:!0}})},M={title:"COMPONENTS/<Game>"},{Story:s}=w();var N=L("<!> <!> <!>",1);function _(o,t){y(t,!1),B(),h();var e=N(),a=G(e);s(a,{name:"component (loadingScreen)",children:($,R)=>{g($,{lang:"en",children:(u,q)=>{S(u,{})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<undefined {...args}>
   <StoryLocale lang="en">
<Game />
</StoryLocale>
