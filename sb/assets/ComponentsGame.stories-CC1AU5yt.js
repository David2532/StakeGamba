import{p as y,t as L,f as G,s as d,n as C,g as c,d as p,a as E,b as P}from"./iframe-CLJ39Hhr.js";import{c as k,s as h,i as w,d as T,S as g,a as b,b as B,e as H,f as x,g as O}from"./create-runtime-stories-xIo9Dm0x.js";import{G as S,t as m}from"./Game-CLRJwIVu.js";import"./_commonjsHelpers-Cpj98o6Y.js";const l=(s,t=C)=>{b(s,{get skipLoadingScreen(){return t().skipLoadingScreen},action:async()=>{var e,a;await((a=(e=t()).action)==null?void 0:a.call(e,t().data))},children:(e,a)=>{g(e,{lang:"en",children:(n,i)=>{S(n,{})},$$slots:{default:!0}})},$$slots:{default:!0}})},M={title:"COMPONENTS/<Game>"},{Story:o}=T();var N=L("<!> <!> <!>",1);function _(s,t){y(t,!1),h(),w();var e=N(),a=G(e);o(a,{name:"component (loadingScreen)",children:($,R)=>{g($,{lang:"en",children:(u,q)=>{S(u,{})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<undefined {...args}>
   <StoryLocale lang="en">
<Game />
</StoryLocale>
