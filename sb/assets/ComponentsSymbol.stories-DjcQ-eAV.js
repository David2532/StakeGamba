import{p as X,t as $,f as t,n as Z,s as S,a as n,b as ee,c as te,e as x,g as e,d as o}from"./iframe-BRObHOZm.js";import{c as ne,i as oe,d as ae,e as d,a as y}from"./create-runtime-stories-CXI0SmX7.js";import{c as u,d as Y,f as R,C as F,T as G}from"./Symbol-DEEm0-fq.js";import"./_commonjsHelpers-Cpj98o6Y.js";const W=["static","spin","land","win","postWinStatic","explosion"],se={title:"Components/<Symbol>",component:u,args:{x:100,y:100,rawSymbol:{name:"S",scatter:!0},state:"static"}},{Story:q}=ae();var re=$("<!> <!>",1),me=$("<!> <!>",1),le=$("<!> <!>",1),ce=$("<!> <!>",1);function j(z,D){X(D,!1);const i=180,J=[{name:"S"},{name:"W"}],K=[{name:"H1"},{name:"H2"},{name:"H3"},{name:"H4"},{name:"H5"},{name:"L2"},{name:"L1"},{name:"L4"},{name:"L3"}];oe();var P=ce(),M=t(P);q(M,{name:"component",template:(g,v=Z)=>{Y(g,{assets:R,children:(O,f)=>{u(O,te(v,{oncomplete:()=>console.log("complete")}))},$$slots:{default:!0}})},$$slots:{template:!0},parameters:{__svelteCsf:{rawCode:`<StoryPixiApp {assets}>
