import{p as y,t as L,f as C,s as d,n as G,g as c,d as p,a as E,b as P}from"./iframe-CR8VUa1w.js";import{c as k,i as h,d as w}from"./create-runtime-stories-ChGwuRIy.js";import{s as b,S as g,a as H,b as T,e as x}from"./Symbol-DDDF6qN3.js";import{G as S,t as m}from"./Game-BSfB1SJc.js";import"./_commonjsHelpers-Cpj98o6Y.js";const l=(o,t=G)=>{H(o,{get skipLoadingScreen(){return t().skipLoadingScreen},action:async()=>{var e,a;await((a=(e=t()).action)==null?void 0:a.call(e,t().data))},children:(e,a)=>{g(e,{lang:"en",children:(n,i)=>{S(n,{})},$$slots:{default:!0}})},$$slots:{default:!0}})},B={title:"COMPONENTS/<Game>"},{Story:r}=w();var O=L("<!> <!> <!>",1);function _(o,t){y(t,!1),b(),h();var e=O(),a=C(e);r(a,{name:"component (loadingScreen)",children:($,M)=>{g($,{lang:"en",children:(u,N)=>{S(u,{})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<undefined {...args}>
   <StoryLocale lang="en">
<Game />
</StoryLocale>
