...
| ------------------------ | :-: | :-----: | :--------: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `load-and-readiness`     | Yes |   Yes   |    Yes     | Cold-load the exact candidate. Record start, first responsive UI, authenticate completion and first legal play readiness. Capture timing source/method, errors, broken assets and whether interaction was possible before final paint.                                                                         |
