...
| --- | --- | --- | --- |
| BSB-RGS-001 | High | DONE | Accept only the documented half-up whole-micro-unit payout for fractional centi-x products; real fixture, boundary, new-play, and restore tests pass. Commit `7162fcd`. |
