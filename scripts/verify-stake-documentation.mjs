...
const requirementSeeds = [
	...
	['Wallet', 'Insufficient Funds wording', 'Insufficient balance copy', 'Every jurisdiction uses the globally safe Insufficient Balance copy.', 'apps/cluster/scripts/build-preview-html.mjs', 'showInsufficientFunds; insufficientBalanceTitle', 'scripts/stake-qa.mjs insufficient-funds', 'scripts/stake-qa-e2e.mjs insufficient-funds', 'Stake Compliance CI / insufficient-balance gate', 'publish/frontend/index.html'],
	['Wallet', 'Stake.us Insufficient Balance wording', 'Stake.us copy', 'XGC/XSC and standard token displays use the same Insufficient Balance copy.', 'apps/cluster/scripts/build-preview-html.mjs', 'showInsufficientFunds; insufficientBalanceTitle', 'scripts/stake-qa.mjs insufficient-funds', 'scripts/stake-qa-e2e.mjs insufficient-funds', 'Stake Compliance CI / global player wording gate', 'publish/frontend/index.html'],
	...
	['Social', 'Social Mode restricted terminology', 'Global player wording', 'Restricted terminology is absent from default, pre-auth, post-auth, Social, standard-token and Replay UI copy.', 'apps/cluster/scripts/build-preview-html.mjs; apps/cluster/scripts/stake-compliance-contract.mjs', 'LANGUAGE_RESOURCES; buildPlayerSafeRulesBodyHtml; playerVisibleRestrictedHits', 'scripts/stake-qa.mjs social', 'scripts/stake-qa-e2e.mjs social; scripts/stake-qa-e2e.mjs replay', 'Stake Compliance CI / Global player wording gate', 'publish/frontend/index.html'],
	...
	['Replay UI', 'Replay Bet Amount visible', 'Replay display', 'Replay Play Amount is visible, display-only and uses the immutable launch amount and token metadata.', baseImplementation, 'renderReplaySummary; replayApiAmountToMoney', 'scripts/stake-qa.mjs replay', 'scripts/stake-qa-e2e.mjs replay', 'Stake Compliance CI / Browser Replay gate', 'publish/frontend/index.html'],
...
${[
	...
	['M', 'Global player wording gate', 'all jurisdictions and first render', 'CI', 'npm run stake:qa', 'wording evidence and screenshots', 'restricted words absent everywhere', 'restricted wording appears in any player-visible path', 'not permitted'],
